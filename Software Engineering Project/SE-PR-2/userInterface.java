...
////////////////Enter Button----> UserFound frame//////////////////
                enter.addActionListener(new ActionListener(){
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        findItem.setBounds(215,345,100,30);
                        returnItem.setBounds(215,385,110, 30);
                        renewItem.setBounds(215,425,110, 30);
                        payFines.setBounds(235,155,110,30);
                        itemsChecked.setBounds(15,185,200, 50);
                        ta.setBounds(15,215,400,100);
                        itemSearched.setBounds(15, 345, 200, 30);
                        ...
                        findItem.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                ...
                                check.addActionListener(new ActionListener() {
                                    ...
                                    public void actionPerformed(ActionEvent e) {
                                        ...
                                        if(availDis.equals("Not Available")){
                                            ...
                                            notAvailable = new JLabel("Item selected is not available for checkout");
                              ...
                              /*  returnItem.addActionListener(new ActionListener() {
                                    ...
                                    public void actionPerformed(ActionEvent e) {
                                        new checkOut(titleDis,searchName.getText());
                                        String [] checkedItems = ReturnItem.display();
                                        if(! itemSearched.getText().isEmpty()) {
                                            tempTitleReturn = itemSearched.getText();
                                            System.out.println("title:" + tempTitle);
                                            new SearchItem(tempTitle);
                                        }
                                    }
